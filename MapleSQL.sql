...
--
-- Host: 45.32.49.85    Database: maplestory
-- ------------------------------------------------------
...
INSERT INTO `accounts` VALUES (16,'admin','$2a$10$B5TFumWuoaFeAz76fwnTS.3zJjtOE5hyeWX/TYzj0uEoN3pWOFniG','$2a$10$B5TFumWuoaFeAz76fwnTS.','111111',0,0,0,0,0,0,4,'',1529306472572);
...
LOCK TABLES `buddy_requests` WRITE;
/*!40000 ALTER TABLE `buddy_requests` DISABLE KEYS */;
/*!40000 ALTER TABLE `buddy_requests` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `characters` VALUES (77,'Tyler',1,0,0,30027,2,20001,0,0,12,4,4,5,0,910000000,16,50,50,5,5,0,0,0,30000,0,0,1,0,0,20);
...
--
-- Dumping data for table `custom_npcs`
--

LOCK TABLES `custom_npcs` WRITE;
/*!40000 ALTER TABLE `custom_npcs` DISABLE KEYS */;
/*!40000 ALTER TABLE `custom_npcs` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `inventory_items` VALUES (72876,-1,77,-5,1040010,1,'',0,-1,-1,'{wdef=3, upgradeSlots=7, itemLevel=1}'),(72877,-1,77,-6,1060002,1,'',0,-1,-1,'{wdef=2, upgradeSlots=7, itemLevel=1}'),(72878,-1,77,-7,1072001,1,'',0,-1,-1,'{wdef=2, upgradeSlots=5, itemLevel=1}'),(72879,-1,77,-11,1312004,1,'',0,-1,-1,'{watk=17, upgradeSlots=7, itemLevel=1}'),(72880,4,77,1,4161001,1,'',0,-1,-1,NULL);
...
CREATE TABLE `notes` (
  ...
  `creation_time` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `notes.character_idx` (`character`),
  CONSTRAINT `notes.character` FOREIGN KEY (`character`) REFERENCES `characters` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-06-18 16:29:23
