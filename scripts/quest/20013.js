...
function start(mode, type, selection) {
	...
	if (status == 2) {
	    qm.sendOk("Hmm, was that too much to ask? Is it because you don''t know how to break Boxes? I'll tell you how if you accept my Quest. Let me know if you change your mind.");
	    qm.dispose();
	    return;
	}
		status--;
...
function end(mode, type, selection) {
    ...
    if (status == 0) {
		...
		qm.giveItem(4032267, -1);
		qm.giveItem(4032268, -1);
		qm.giveItem(3010060, 1);
		qm.forceCompleteQuest();
		qm.forceCompleteQuest(20000);
		qm.forceCompleteQuest(20001);
		qm.forceCompleteQuest(20002);
		qm.forceCompleteQuest(20015);
		qm.getCharacter().giveExp(95);
		qm.sendGuideHint(10, 5000);
		qm.dispose();
    }
}