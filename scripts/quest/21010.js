...
function start(mode, type, selection) {
	...
	if (status == 0) {
		...
		if (!qm.isQuestStarted(21010)) {
			qm.getCharacter().setHp(25);
			qm.giveItem(2000022, 1);
			qm.forceStartQuest();
		}
...
function end(mode, type, selection) {
	...
	if (status == 0) {
		...
		if (qm.isQuestStarted(21010) && !qm.isQuestCompleted(21010)) {
			qm.giveExp(16);
			qm.giveItem(2000022, 3);
			qm.giveItem(2000023, 3);
