...
public enum MonsterStatus {
    ...
    private final int i;
    private final boolean canApplyToBosses;
    
    private MonsterStatus(int i, boolean canApplyToBosses) {
        this.i = i;
        this.canApplyToBosses = canApplyToBosses;
    }

    private MonsterStatus(int i) {
    	this.i = i;
    	canApplyToBosses = true;
    }
	...
	public boolean canApplyToBosses() {
		return canApplyToBosses;
	}
}
